      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="col-span-1">
            <Link href="/" className="inline-flex mb-4">
              <Image src="/fizzup-logo.png" alt="FizzUp" width={110} height={33} className="h-8 w-auto" />
            </Link>
            <p className="text-sm text-gray-500 leading-relaxed max-w-[200px]">
              Connecté pour mieux trinquer. Objets connectés, app sociale et dashboard pour réinventer la convivialité.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-white/6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-600">
            © {currentYear} FizzUp. Tous droits réservés.
          </p>
          <div className="flex gap-4">
            <a href="#" aria-label="Twitter" className="text-gray-600 hover:text-gray-300 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="#" aria-label="GitHub" className="text-gray-600 hover:text-gray-300 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" aria-label="LinkedIn" className="text-gray-600 hover:text-gray-300 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
